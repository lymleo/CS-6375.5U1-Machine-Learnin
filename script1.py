...
# first layer: fully connected ReLU with 4096 nodes
...
# second layer: fully connected ReLU with 80 nodes and dropouts
...
v_fc2_drop = tf.nn.dropout(v_fc2, keep_prob) # v_fc2_drop ?x10
